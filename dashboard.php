...
if (isset($_GET['pages'])) {
    if ($_GET['pages'] == "konsultasi") {
        ...
        $page = "Bimbingan Pranikah";
        $file = "XCRUD";
    } elseif ($_GET['pages'] == "jadwal-bimbingan") {
        $page = "Jadwal Bimbingan";
        $file = "XCRUD";
    } elseif ($_GET['pages'] == "absensi-bimbingan") {
        $page = "Absensi Bimbingan";
        $file = "XCRUD";
        ...
        $file = "NON";
    } elseif ($_GET['pages'] == "l-absensi-pranikah") {
        $page = "Laporan Absensi Pranikah";
        $file = "NON";
    } elseif ($_GET['pages'] == "l-bimbingan") {
        $page = "Laporan Sesi Bimbingan";
        $file = "NON";
            ...
            <section class="content">
                ...
                if (isset($_GET['pages'])) {
                    if ($_GET['pages'] == "konsultasi") {
                        ...
                        include 'pages/jadwal-bimbingan.php';
                    } elseif ($_GET['pages'] == "absensi-bimbingan") {
                        include 'pages/absensi-bimbingan.php';
                    } elseif ($_GET['pages'] == "rekomendasi") {
                        ...
                        include 'pages/lap-absensi-pranikah.php';
                    } elseif ($_GET['pages'] == "l-bimbingan") {
                        include 'pages/lap-sesi-bimbingan.php';
