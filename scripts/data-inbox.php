    ...
    <tbody>
        <?php if ($count > 0) : ?>
            <?php while ($data = $query->fetch_array()) : ?>
                <tr>
                    <td class="mailbox-name"><a href="dashboard?pages=detail-pesan-masuk&id=<?= $data['id_k'] ?>"><?= $data['nama'] ?></a></td>
                    <td class="mailbox-subject"><b><?= $data['judul_pesan'] ?></b> -
                        <?= substr($data['pesan'], 0, 7) . '...'  ?>
                    </td>
